...
export default function Unsafe() {
  ...
  const loginSubmit = () => async (e) => {
    ...
    try {
      const res = await axios.post("http://localhost:7070/safe/login", {
        username,
        password,
      });
      ...
      console.error("Error in POST /safe/login", error);
    }
    setUsername("");
    setPassword("");
  };
  ...
  const updatePass = () => async (e) => {
    ...
    try {
      const res = await axios.post("http://localhost:7070/safe/update", {
        username,
        oldpass: oldPass,
        newpass: newPass,
      });
      ...
      console.error("Error in POST /safe/update", error);
    }
  };
